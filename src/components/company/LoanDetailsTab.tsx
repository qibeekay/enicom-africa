					...
					<div className='flex flex-col md:flex-row gap-5 md:gap-10 items-center mt-4'>
						...
						<div className='w-full text-sm'>
							<p>
								...
								rate and for an agreed period.  We believe that everyone should
								have access to clean, renewable energy solutions. That's why we
								offer flexible loan financing options to help you go solar
								without breaking the bank. With our loan finance option, you can
								enjoy the benefits of solar energy while spreading the cost over
								time.
							</p>

							<p className='font-medium mt-2'>Advantage:</p>
							...
							<p>
								<span className='font-medium'>Disadvantage:</span> You pay
								Interest rates on the solar loan approved. You risk the loss of
								collateral—whether the home or the system itself—if you’re
